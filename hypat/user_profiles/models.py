...
class Profile(models.Model):
    ...
    bio = models.TextField(
        max_length=500, blank=True, help_text="A short biography about the user"
    )
    ...
    birth_date = models.DateField(null=True, blank=True, help_text="User's birthday")
    ...
    def get_absolute_url(self):
        ...
        return reverse(
            "user_profiles:profile_detail", kwargs={"slug": self.user.username}
        )
