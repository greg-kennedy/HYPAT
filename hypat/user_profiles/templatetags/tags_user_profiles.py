...
def user(pk):
    ...
    if pk:
        try:
            ...
            type = 'superuser' if object.is_superuser else 'staff' if object.is_staff else 'user'
            return { 'id': pk, 'username': object.get_username(), 'type': type, 'is_active': object.is_active }
